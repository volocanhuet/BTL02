...
public class PlayGame extends JPanel implements Runnable,ActionListener{
	...
	private void innitCompts(){         //menu in game
	...
	private KeyAdapter keyAdapter = new KeyAdapter() {      //thao tac de nhap va tu phim
		@Override
		public void keyPressed(KeyEvent e) {            //trieuj hoi phim nhan
			traceKey.set(e.getKeyCode());
		}
		
		@Override
		public void keyReleased(KeyEvent e) {           //trieu hoi phim nha ra
