...
public class Bomb extends Actor{
	...
	public Bomb(int x, int y, int size, int timeline){
		x=(x/45)*45;                //de cho boom dat dung vi tri k bi lech o
		y=(y/45)*45;
		this.x=x;
		this.y=y;
		this.size=size;
	...
	public int isImpactBombvsActor(Actor actor){            //tra ve o class Actor 
		if(actor.getRunBomb()==Bomber.ALLOW_RUN) {      //check co the run dc k
			return 0;
		}
		Rectangle rec2 = new Rectangle(x, y, 45, 45);
